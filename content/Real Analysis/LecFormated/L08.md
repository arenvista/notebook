...
> [!pf]  If $a\in\mathbb{R}\setminus\{0\}$, prove $\dfrac{1}{-a}=-\left(\dfrac{1}{a}\right)$.
...
> [!pf] If $C>1$ and $m,n\in\mathbb{Z}$, prove
> $$
...
> [!pf] Proof Let $x_n\to x$ and $y_n\to y$. Prove $\displaystyle\lim_{n\to\infty}(x_ny_n)=xy$.
> For any $n$,
> $$
